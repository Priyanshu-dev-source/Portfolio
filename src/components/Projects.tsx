...
const projectsData = [
  ...
  },
  {
    ...
    description:
      "I developed a dashboard and informational website for our college club Vyomnoutes, focused primarily on frontend design and user experience. It showcases the club’s activities, events, and key information in a structured and engaging way. The website ensures easy navigation and a clean interface for users. It reflects my skills in building responsive and visually appealing web applications.",
    image: "/vyomnauts.png",
    video: "/vyomnauts.mp4",
  ...
  },
  {
    ...
    description:
      "Bus Buddy is a real-time bus tracking system that uses IoT devices to provide live location updates. It helps users track buses accurately, ensuring faster and smoother transportation. The system improves convenience and reduces waiting time with reliable tracking.",
    image: "/busbuddy.png",
    video: "/busbuddy.mp4",
  },
  {
  ...
  },
  {
    ...
    description:
      "Med Buddy is an online healthcare platform where users and doctors can register and connect for real-time appointments. It allows patients to consult doctors, receive medical suggestions, and access emergency ambulance support. The platform streamlines healthcare access with quick and reliable services.",
    image: "/medbuddy2.jpg",
    video: "/medbuddy.mp4",
  },
  {
    ...
    description:
      "WeatherNet is a web application that fetches real-time weather data using APIs to display current conditions of any location. It provides accurate and up-to-date information like temperature, humidity, and forecasts. The platform ensures a simple and clean interface for quick weather insights.",
...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="relative w-full bg-transparent font-sans overflow-hidden py-12 md:py-16 lg:px-26"
    >
      {/* Header */}
      ...
      <motion.div
        ...
        className="mb-8 md:mb-12 text-left px-6 md:px-16"
      >
        ...
        <p className="text-gray-600 font-lighter text-lg md:text-[18px] max-w-2xl leading-relaxed">
          A showcase of my work where ideas come to life through creativity,
          code, and problem-solving.
        </p>
      </motion.div>

      {/* Projects Grid/Flex Layout */}
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 w-full min-h-[300px] md:min-h-[450px]">
        {projectsData.map((project, idx) => {
          // Calculate grid positions
          const hasCardBelowMobile = idx + 2 < projectsData.length;
          ...
          return (
            <motion.div
              ...
              className={`group relative flex flex-col justify-between p-5 sm:p-6 md:p-8 lg:p-10 cursor-pointer transition-colors duration-500 overflow-hidden border-gray-200 border-r ${
            ...
            >
              ...
              <div className="flex-grow flex items-center justify-center relative z-10">
                <span className="text-[5rem] sm:text-[6rem] md:text-[7rem] lg:text-[10rem] font-light leading-none text-gray-900 group-hover:text-white transition-colors duration-500 select-none">
                  {project.number}
                </span>
              </div>
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4 md:p-8">
          ...
          <div className="relative w-full max-w-5xl h-[85vh] sm:h-[90vh] md:h-auto md:max-h-[90vh] bg-white rounded-2xl sm:rounded-3xl overflow-y-auto overflow-x-hidden shadow-2xl flex flex-col animate-in fade-in zoom-in duration-300 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <button
              onClick={closeModal}
              className="absolute top-3 right-3 sm:top-6 sm:right-6 z-20 p-2 sm:p-2.5 bg-black/40 hover:bg-[#ea5b25] text-white rounded-full transition-all duration-300 backdrop-blur-md"
            >
              <svg
                width="24"
                height="24"
            ...
            <div className="relative px-5 sm:px-8 md:px-16 pt-0 pb-8 sm:pb-12 -mt-16 sm:-mt-20 md:-mt-24 z-10 flex-grow">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-[#ea5b25] font-semibold text-base sm:text-lg md:text-xl mb-5 sm:mb-8 tracking-wide">
                  {selectedProject.subtitle}
                </p>

                <p className="text-gray-700 text-sm sm:text-base md:text-[16px] leading-relaxed whitespace-pre-wrap font-medium">
